...
DEFAULT_DIST_SUCCESS_END = 0.10
DEFAULT_ORI_SUCCESS_START = 2.0
DEFAULT_ORI_SUCCESS_END = 0.85
DEFAULT_CURRICULUM_EPISODES = 5000
...
DEFAULT_WRIST_TABLE_PENALTY_SCALE = 20.0
...
def main():
    ...
    parser.add_argument("--collision_penalty_scale", type=float, default=10.0)
    parser.add_argument(
    ...
    parser.add_argument("--action_penalty_scale", type=float, default=2.0)
